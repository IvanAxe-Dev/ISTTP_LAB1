...
namespace FinancesMVC.Controllers
{
    public class UserProfilesController : Controller
    {
        ...
        public UserProfilesController(Db1Context context)
        {
            _context = context;
        }
        ...
        {
            var db1Context = _context.UserProfiles.Include(u => u.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,FirstName,LastName,Birthdate,Country,AboutMe")] UserProfile userProfile)
        {
